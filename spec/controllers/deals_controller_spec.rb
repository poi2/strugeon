  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved deal as @deal" do
        post :create, {:deal => invalid_attributes}, valid_session
        expect(assigns(:deal)).to be_a_new(Deal)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested deal" do
        deal = Deal.create! valid_attributes
        put :update, {:id => deal.to_param, :deal => new_attributes}, valid_session
        deal.reload
    ...
    context "with invalid params" do
      it "assigns the deal as @deal" do
        deal = Deal.create! valid_attributes
        put :update, {:id => deal.to_param, :deal => invalid_attributes}, valid_session
        expect(assigns(:deal)).to eq(deal)
      end
